...
lotter_num[0] = int(input("1번째 로또 숫자는(1~45) = "))
lotter_num[1] = int(input("2번째 로또 숫자는(1~45) = "))
lotter_num[2] = int(input("3번째 로또 숫자는(1~45) = "))
lotter_num[3] = int(input("4번째 로또 숫자는(1~45) = "))
lotter_num[4] = int(input("5번째 로또 숫자는(1~45) = "))
lotter_num[5] = int(input("6번째 로또 숫자는(1~45) = "))
